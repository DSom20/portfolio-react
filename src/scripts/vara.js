let Vara = function(elem, fontSource, text, properties) {
  var _this = this;
...
Vara.prototype.getSVGData = function() {
  var _this = this;
  // I DCSommers added the if clause to allow for direct input of object instead
  // of string pointing to JSON file on github
  if (typeof _this.fontSource === "object") {
    _this.contents = _this.fontSource;
    _this.characters = _this.fontSource.c;
    _this.preCreate();
    _this.createText();
  } else {
  ...
  for (var j = 0; j < this.texts.length; j++) {
    ...
    'data-text':this.texts[j].text
      ...
      for (var x = 0; x < this.texts[j].text.length; x++) {
        ...
        //   console.log(fg.__proto__.__proto__.getBBox)
        //   fg.getBBox = fg.__proto__.__proto__.getBBox;
        //   console.log(fg.getBBox);
